...
export const AstrounautIllustration = styled.image`
  ...
  position: absolute;
  background-image: url("../../assets/home-mars-right.svg");
...
export const ContainerForm = styled.div`
  display: flex;
  width: 100%;
  background: url("../../assets/background-stars-form.png") no-repeat;
  background-size: cover;
...
export const IconForm = styled.div`
  background: url("../../assets/icon-ticket.svg") no-repeat;
  width: ${pixelToRem(56)};
